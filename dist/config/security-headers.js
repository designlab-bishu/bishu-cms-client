...
export function buildCsp(options = {}) {
    ...
    if (!consoleUrl) {
        ...
        console.warn("[cms-client] CMS_API_URL 이 없어 CSP 에 콘솔 오리진을 넣지 못했습니다.\n" +
    ...
    return [
        ...
        directive("script-src", merge(["'self'", "'unsafe-inline'"], GA4_SCRIPT, consoleOrigin, options.scriptSrc, 
